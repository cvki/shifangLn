...
def config_params():
    ...
    # logs
    parser.add_argument('--saved_path', default='work_dirs_lighting/models2',
...
if __name__ == '__main__':
    ...
    def main():
        ...
        scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=args.milestones, gamma=args.gamma, last_epoch=-1)

        writer = SummaryWriter(summary_path)
        test_min_loss, test_min_r_mse_error, test_min_rot_error = float('inf'), float('inf'), float('inf')
